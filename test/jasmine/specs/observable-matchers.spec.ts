import {
    ...
    next,
    observable, observableMatching, observableWithSize, record
...
describe('Observable Matchers', () => {
    describe('Matchers', () => {
        it('should support empty streams', () => {
            ...
            expect(empty$).toMatchObservable([completed()]);
    ...
    describe('Asymmetric matchers', () => {
        ...
        it('should support matching streams', () => {
            ...
            expect(bar$).toEqual(observable(
                next({value: jasmine.stringMatching('a'), otherValue: jasmine.stringMatching('c')}),
                next({value: jasmine.stringMatching('b'), otherValue: jasmine.stringMatching('d')}),
                completed(),
            ));
